...
BBA in Management Information Systems, Haigazian University '26. I manage a personal homelab on a 32-bit Debian server hosting production services, focusing on Linux administration, automation, and self-hosted infrastructure. Actively building toward remote DevOps / Linux sysadmin opportunities.
...
| **Monitoring** | Prometheus · Netdata · Telegram bot | Service health alerts, systemd state tracking, status page |
...
- [x] Observability — Prometheus + Netdata + service status page
...
- [i386-monitoring-stack](https://github.com/PoladianDev/i386-monitoring-stack) — Prometheus, Node Exporter, Netdata + self-updating service status page with Telegram alerting, running on Debian 11 i386
